...
<?php $this->beginPage() ?>
    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            })(window, document,'script','https://mc.yandex.ru/metrika/tag.js?id=103799675', 'ym');

            ym(103799675, 'init', {ssr:true, webvisor:true, clickmap:true, ecommerce:"dataLayer", accurateTrackBounce:true, trackLinks:true});
        </script>
        <noscript><div><img src="https://mc.yandex.ru/watch/103799675" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
        <!-- /Yandex.Metrika counter -->

        <?php $this->head() ?>
    </head>
    <body class="lang-<?= Yii::$app->language ?>">
    <?php $this->beginBody() ?>
