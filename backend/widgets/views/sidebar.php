    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <!-- Прочие разделы -->
                <li class="nav-item">
                    <a href="<?= Url::to(['/books']) ?>" class="nav-link <?= StaticFunctions::isActive('books') ?>">
                ...
                <li class="nav-item">
                    <a href="<?= Url::to(['/articles']) ?>" class="nav-link <?= StaticFunctions::isActive('articles') ?>">
                ...
                <li class="nav-item">
                    <a href="<?= Url::to(['/event-program']) ?>" class="nav-link <?= StaticFunctions::isActive('event-program') ?>">
                ...
                <li class="nav-item">
                    <a href="<?= Url::to(['/tags']) ?>" class="nav-link <?= StaticFunctions::isActive('tags') ?>">
                ...
                <li class="nav-item">
                    <a href="<?= Url::to(['/locations']) ?>" class="nav-link <?= StaticFunctions::isActive('locations') ?>">
                ...
                <li class="nav-item">
                    <a href="<?= Url::to(['/menu']) ?>" class="nav-link <?= StaticFunctions::isActive('menu') ?>">
                ...
                <li class="nav-item">
                    <a href="<?= Url::to(['/social-links']) ?>" class="nav-link <?= StaticFunctions::isActive('social-links') ?>">
                ...
                <li class="nav-item has-treeview <?= StaticFunctions::isGroupActive(['pages', 'page-sections', 'sections']) ? 'menu-open' : '' ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= Url::to(['/sections']) ?>" class="nav-link <?= StaticFunctions::isActive('sections') ?>">
                                <i class="fas fa-layer-group nav-icon"></i>
                                <p>Секции</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= Url::to(['/pages']) ?>" class="nav-link <?= StaticFunctions::isActive('pages') ?>">
                                <i class="fas fa-file-alt nav-icon"></i>
                                <p>Страницы</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= Url::to(['/page-sections']) ?>" class="nav-link <?= StaticFunctions::isActive('page-sections') ?>">
                ...
                <li class="nav-item has-treeview <?= StaticFunctions::isGroupActive(['subscribers', 'registration']) ? 'menu-open' : '' ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= Url::to(['/subscribers']) ?>" class="nav-link <?= StaticFunctions::isActive('subscribers') ?>">
                                <i class="fas fa-envelope nav-icon"></i>
                                <p>Подписчики</p>
                            </a>
                        </li>
                        <li class="nav-item">
                            <a href="<?= Url::to(['/registration']) ?>" class="nav-link <?= StaticFunctions::isActive('registration') ?>">
                                <i class="fas fa-user-plus nav-icon"></i>
                                <p>Регистрации на саммит</p>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item has-treeview <?= StaticFunctions::isGroupActive(['rbac', 'source-message', 'settings']) ? 'menu-open' : '' ?>">
                    ...
                    <ul class="nav nav-treeview">
                        <li class="nav-item">
                            <a href="<?= Url::to(['/settings']) ?>" class="nav-link <?= StaticFunctions::isActive('settings') ?>">
                                <i class="fas fa-cog nav-icon"></i>
                                <p>Настройки значений</p>
                            </a>
                        </li>
                        <li class="nav-item">
