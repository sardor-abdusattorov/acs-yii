        ...
        <div class="card">
            <div class="card-body">
                ...
                <?= $form->field($model, 'name')->textInput([
                    'maxlength' => true,
                    'placeholder' => 'Example: location1, oqqush, park_istiklol'
                ])->hint('Только латинские буквы, цифры, дефис или нижнее подчеркивание. Без пробелов.') ?>
                ...
                <?= $form->field($model, 'image')->widget(FileInput::class, [
                    ...
                    'pluginOptions' => [
                        ...
                        'showUpload' => false,
                        'browseLabel' => 'Выбрать',
                        'deleteUrl' => Url::to(['locations/delete-image']),
                ...
                <?= $form->field($model, 'galleryImages[]')->widget(FileInput::class, [
                    ...
                    'pluginOptions' => [
                        ...
                        'showUpload' => false,
                        'browseLabel' => 'Выбрать',
                        'deleteUrl' => Url::to(['locations/delete-gallery-image']),
                        'allowedFileExtensions' => ['jpg', 'jpeg', 'png', 'gif', 'webp'],
                    ]
