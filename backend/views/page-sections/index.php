...
/** @var common\models\PageSectionsSearch $searchModel */
/** @var yii\data\ActiveDataProvider $dataProvider */

$this->title = 'Секции страниц';
...
//            'id',
            ...
            [
                ...
                'format' => 'raw',
                'value' => function ($model) {
                    return $model->page->name ?? '(не указано)';
                },
                'filter' => Select2::widget([
                    'model' => $searchModel,
                    'attribute' => 'page_id',
                    'data' => PageSectionsSearch::getPageList(),
            ...
            [
                ...
                'buttons' => [
                    'allButtons' => function ($url, $model, $key) {
                        ...
                        if (Yii::$app->user->can('delete page-section')) {
